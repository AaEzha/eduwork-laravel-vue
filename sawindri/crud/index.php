...
<a href="add.php" class="btn btn-primary mb-3">Add New Buku</a>
    ...
    <?php  
        while($buku_data = mysqli_fetch_array($buku)) {         
            ...
            echo "<td><a class='badge badge-primary' href='edit.php?isbn=$buku_data[isbn]'>Edit</a> | <a class='badge badge-danger' href='delete.php?isbn=$buku_data[isbn]'>Delete</a></td></tr>";        
        }
    ?>
    </table>
</body>
